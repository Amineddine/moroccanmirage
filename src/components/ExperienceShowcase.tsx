...
const experiences = [
  ...
  },
  {
    ...
    desc: "Atlas escapes where ancient tradition meets the silence of the peaks.",
    img: "https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=1200&q=80",
  },
];

export default function ExperienceShowcase() {
  return (
    <section id="experiences" className="w-full bg-alabaster pb-48 lg:pb-64 selection:bg-obsidian selection:text-sandstone">
      {/* Reduced block of space directly underneath Hero */}
      <div className="h-[10vh] sm:h-[15vh] lg:h-[25vh] w-full bg-alabaster" />

      <div className="mx-auto max-w-[1440px] px-6 lg:px-16 translate-x-[120px]">
        {/* Header */}
        <motion.div
          ...
          className="mb-32 md:mb-64 flex flex-col items-center text-center w-full"
        >
        ...
        <div className="flex flex-col items-center gap-16 lg:gap-32 w-full mx-auto">
